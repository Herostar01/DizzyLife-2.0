...
export default () => {
    ...
    return (
            <div style={{backgroundColor: "green", backgroundImage: `url(${hopeimg})`, width: "1800px", height: "1200px"  }} >
                <div style={{display: "flex", justifyContent: "flex-end", fontSize: "25px"}} >
                <Link to={'/dizzylife/'}> Return Home </Link>
                </div>
        <form onSubmit={onSubmitHandler}>
            <p>
                <label style={{  fontSize: "25px"}}> Name </label><br/>
                <input type="text" onChange={(e)=>setTitle(e.target.value)} value={title}/>
            </p>
            <p>
                <label style={{  fontSize: "25px"}} > About Me </label><br/>
                <input type="text" onChange={(e)=>setPrice(e.target.value)} value={price}/>
            </p>
            <p>
                <label style={{  fontSize: "25px"}} > Advice, Feedback, or Experience </label><br/>
